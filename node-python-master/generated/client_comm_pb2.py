...
UploadFileRequest = _reflection.GeneratedProtocolMessageType(
    "UploadFileRequest",
    (_message.Message,),
    {
...
UploadFileReply = _reflection.GeneratedProtocolMessageType(
    "UploadFileReply",
    (_message.Message,),
    {
...
DownloadFileRequest = _reflection.GeneratedProtocolMessageType(
    "DownloadFileRequest",
    (_message.Message,),
    {
...
DownloadFileReply = _reflection.GeneratedProtocolMessageType(
    "DownloadFileReply",
    (_message.Message,),
    {
