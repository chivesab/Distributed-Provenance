...
_REPLICATIONDETAILSREQUEST = DESCRIPTOR.message_types_by_name[
    "ReplicationDetailsRequest"
]
_REPLICATIONDETAILSRESPONSE = DESCRIPTOR.message_types_by_name[
    "ReplicationDetailsResponse"
]
...
_GETNODEFORDOWNLOADREQUEST = DESCRIPTOR.message_types_by_name[
    "GetNodeForDownloadRequest"
]
_GETNODEFORDOWNLOADRESPONSE = DESCRIPTOR.message_types_by_name[
    "GetNodeForDownloadResponse"
]
...
NodeIpsRequest = _reflection.GeneratedProtocolMessageType(
    "NodeIpsRequest",
    (_message.Message,),
    {
...
NodeIpsReply = _reflection.GeneratedProtocolMessageType(
    "NodeIpsReply",
    (_message.Message,),
    {
...
ReplicationDetailsRequest = _reflection.GeneratedProtocolMessageType(
    "ReplicationDetailsRequest",
    (_message.Message,),
    {
...
ReplicationDetailsResponse = _reflection.GeneratedProtocolMessageType(
    "ReplicationDetailsResponse",
    (_message.Message,),
    {
...
NewNodeUpdateRequest = _reflection.GeneratedProtocolMessageType(
    "NewNodeUpdateRequest",
    (_message.Message,),
    {
...
NewNodeUpdateResponse = _reflection.GeneratedProtocolMessageType(
    "NewNodeUpdateResponse",
    (_message.Message,),
    {
...
GetNodeForDownloadRequest = _reflection.GeneratedProtocolMessageType(
    "GetNodeForDownloadRequest",
    (_message.Message,),
    {
...
GetNodeForDownloadResponse = _reflection.GeneratedProtocolMessageType(
    "GetNodeForDownloadResponse",
    (_message.Message,),
    {
...
GetNodeForUploadRequest = _reflection.GeneratedProtocolMessageType(
    "GetNodeForUploadRequest",
    (_message.Message,),
    {
...
GetNodeForUploadResponse = _reflection.GeneratedProtocolMessageType(
    "GetNodeForUploadResponse",
    (_message.Message,),
    {
...
NodeDownUpdateRequest = _reflection.GeneratedProtocolMessageType(
    "NodeDownUpdateRequest",
    (_message.Message,),
    {
...
NodeDownUpdateResponse = _reflection.GeneratedProtocolMessageType(
    "NodeDownUpdateResponse",
    (_message.Message,),
    {
...
GetListOfFilesRequest = _reflection.GeneratedProtocolMessageType(
...
GetListOfFilesResponse = _reflection.GeneratedProtocolMessageType(
...
GetListOfNodesRequest = _reflection.GeneratedProtocolMessageType(
...
GetListOfNodesResponse = _reflection.GeneratedProtocolMessageType(
    "GetListOfNodesResponse",
    (_message.Message,),
    {
